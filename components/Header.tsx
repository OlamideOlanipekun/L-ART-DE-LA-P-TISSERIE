  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50">
      ...
      <div className="bg-stone-900 text-white py-2 px-6 text-center overflow-hidden border-b border-white/5">
        <p className="text-[8px] lg:text-[9px] font-bold tracking-[0.2em] lg:tracking-[0.3em] uppercase whitespace-nowrap">
          Complimentary signature gift box with every seasonal collection order
        </p>
      </div>

      <header className="bg-white/80 backdrop-blur-xl border-b border-stone-100 transition-all duration-300">
        <div className="max-w-7xl mx-auto px-6 h-16 lg:h-20 flex items-center justify-between">
          <div className="flex items-center space-x-6 lg:space-x-12">
            {/* Mobile Menu Toggle */}
            <button 
              onClick={onOpenMobileMenu}
              className="p-2 -ml-2 text-stone-900 hover:text-gold transition-colors"
            ...
            <button 
              ...
              className="text-base lg:text-xl font-serif tracking-[0.2em] lg:tracking-[0.25em] text-stone-900 group whitespace-nowrap"
            >
